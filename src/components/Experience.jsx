...
const ExperienceCard = ({ exp }) => (
  <div 
    data-aos="fade-up"
    className="bg-black/25 backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:bg-black/35 hover:shadow-[0_20px_50px_rgba(37,99,235,0.15)] hover:border-blue-500/20 transition-all duration-500 max-w-4xl mx-auto"
  >
    <div className="flex flex-col md:flex-row gap-8 justify-between">
      ...
      <div className="flex-1 md:border-r md:border-white/10 md:pr-8">
        ...
        <p className="text-blue-400 text-lg font-black tracking-wide mb-6 uppercase">
          {exp.organization}
        </p>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {exp.tech.map((t) => (
              <span 
                key={t}
                className="px-3 py-1.5 text-xs font-mono font-bold text-white bg-white/5 rounded-full border border-white/10 hover:bg-blue-500/20 hover:border-blue-500/30 transition-all cursor-default"
              >
                {t}
              </span>
            ))}
...
const Experience = () => {
  return (
    <section id="experience" className="bg-[#2563eb] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans">
