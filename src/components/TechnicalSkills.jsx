...
const SkillProgress = ({ name, level }) => (
  <div className="mb-4">
    ...
    <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden border border-white/5">
      <div 
        className="h-full bg-gradient-to-r from-blue-700 to-blue-400 rounded-full transition-all duration-1000 ease-out"
        style={{ width: `${level}%` }}
      />
    </div>
  </div>
...
const SkillCard = ({ category, index }) => (
  <div 
    ...
    className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:scale-[1.02] hover:border-blue-500/30 hover:shadow-[0_20px_50px_rgba(37,99,235,0.1)] transition-all duration-500"
  >
